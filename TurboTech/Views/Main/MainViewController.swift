...
enum TabItem: String, CaseIterable {
    ...
    var icon: UIImage? {
        ...
        case .location: return UIImage(systemName: "house.fill")
        case .message: return UIImage(systemName: "house.fill")
        case .profile: return UIImage(systemName: "house.fill")
        case .login: return UIImage(systemName: "house.fill")
        }
    }
