...
class SpeedTestViewController: UIViewController, WKNavigationDelegate{
    ...
    override func viewDidLoad(){
        super.viewDidLoad()
        navigatorGeolocation.setUserContentController(webViewConfiguration: webConf)
        webView.navigationDelegate = self
//        webView.uiDelegate = self
        let url = URL(string: "http://chinapheak.speedtestcustom.com/")
...
extension SpeedTestViewController : WKUIDelegate {
}
